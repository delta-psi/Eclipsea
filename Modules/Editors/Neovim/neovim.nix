...

{
  programs.nixvim = lib.mkMerge [
    ...
    (import ./options.nix)
    {
      plugins = import ./Plugins/plugins.nix {
        inherit lib pkgs;
      };
    }
  ];
...
#       outputHashes = {
#         "ratex-font-0.1.4" = "sha256-/iYc5D2jnNGmztYsAnHJuV84XkS9E8EbZTE4xHwp9ic="; # "0rqaf1khzi4ap4fjd3pbjmjmdi0jlczy2khrrqz5h13lsfvj9c3r";
#       };
#     };
#   };
# in
...
#         #     owner = "techwizrd";
#         #     repo = "render-latex.nvim";
#         #     rev = "v0.1.0-rc3"; # latest release as of now
#         #     hash = "sha256-aPoUVIR9wx/7F7dkzXht6ipm/A+tYYWPrRV21Ixs4Oo="; 
#         # };
#       # })
#       # (buildVimPlugin {
